...
//        //set all Meal Indicators to false
        ...
        statusbreakfast = new Meal(R.theBlankMeal);
        statusmondayLunch = new Meal(R.theBlankMeal);
        statusmondayDinner = new Meal(R.theBlankMeal);
        statustuesdayLunch = new Meal(R.theBlankMeal);
        statustuesdayDinner = new Meal(R.theBlankMeal);
        statuswednessdayLunch = new Meal(R.theBlankMeal);
        statuswednessdayDinner = new Meal(R.theBlankMeal);
        statusthursdayLunch = new Meal(R.theBlankMeal);
        statusthursdayDinner = new Meal(R.theBlankMeal);
        statusfridayLunch = new Meal(R.theBlankMeal);
        statusfridayDinner = new Meal(R.theBlankMeal);
        statussaturdayLunch = new Meal(R.theBlankMeal);
        statussaturdayDinner = new Meal(R.theBlankMeal);
        statussundayLunch = new Meal(R.theBlankMeal);
        statussundayDinner = new Meal(R.theBlankMeal);
    ...
    public void updateAllIndicators() {  //exact copy in MenuView
        try {
            ...
            alert.error("Menu has Invalid negative Meal ID's - IndexOutOfBoundsException - MakeMealView.updateAllIndicators()");
        }
