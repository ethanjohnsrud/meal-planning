...
import static mealplanning.MealPlanning.Catalog;
import static mealplanning.MealPlanning.Menu;
import static mealplanning.MealPlanning.ShoppingList;
...
public class Save {
    ...
    public ObservableList<Meal> Catalog = MealPlanning.Catalog;
    private String menuSaveFile = "Menu.csv";
    private String menuPrintFile = "Menu.txt";
    public ObservableList<Meal> Menu = MealPlanning.Menu;
    private String shoppingListPrintFile = "ShoppingList.txt";
    public ObservableList<Meal> ShoppingList = MealPlanning.ShoppingList;
    ...
    try {
        ...
        new AlertBox().notify("><File - Catalog - Sucessfully Loaded>< - Save.catalogInport()");

    } catch(NumberFormatException exe) {
    alert.error("***><><***NumberFormatException - Meal skipped ***><><*** - Save.catalogInport()");
    ...
    alert.error("***><><***FILE NOT FOUND INPORT FAILED***><><*** - Save.catalogInport()");
    } catch(NullPointerException ee) {
        alert.error("***><><***NULL POINTER INPORT FAILED***><><*** - Save.catalogInport()");
    } catch(NoSuchElementException e) {
    alert.error("***><><***NumberFormatException INPORT FAILED***><><*** - Save.catalogInport()");               
    }
    }
    ...
    try {
        ...
        inputStream.close();
        new AlertBox().notify("><File - Menu - Sucessfully Loaded>< - Save.menuInport()");

    } catch(NumberFormatException exe) {
    alert.error("***><><***NumberFormatException - Meal skipped ***><><***- Save.menuInport()");
    alert.error("Line: "+line);
    String skipped = inputStream.nextLine();     
    alert.error("--->lastRead: "+lastRead+" -> "+skipped);
    }
    } catch(FileNotFoundException ex) {
    alert.error("***><><***FILE NOT FOUND INPORT FAILED***><><*** - Save.menuInport()");
    } catch(NullPointerException ee) {
        alert.error("***><><***NULL POINTER INPORT FAILED***><><*** - Save.menuInport()");
    } catch(NoSuchElementException e) {
    alert.error("***><><***NumberFormatException INPORT FAILED***><><*** - Save.menuInport()");               
    }
    }
