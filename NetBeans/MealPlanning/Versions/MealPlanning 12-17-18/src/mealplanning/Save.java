...
public class Save {
    ...
    public void importData() {
        if(!sampleFill) {
            ...
            menuImport();
            recentImport();
           new AlertBox().notify("><File - Catalog - Menu - Recent - Sucessfully Loaded>< - Save.importData()");
        }
        return;
}
    ...
    public void exportData() {
        ...
        recentExport();
        shoppingListExport();
        new AlertBox().notify("><File - Catalog - Menu - Recent - ShoppingList - Sucessfully Saved>< - Save.importData()");
        return;
    }
    ...
    try {
        while(inputStream.hasNext()) { 
           ...
           lastRead = inputStream.next();
            ...
            Meal newMeal = new Meal(true,id,name,meat,carb,vegetable,fruit,false);
        ...
        try{
           ...
           lastRead = inputStream.next();
            ...
            if(id < 0) {
                ...
                newMeal = new Meal(false,id,name,meat,carb,vegetable,fruit,false);
