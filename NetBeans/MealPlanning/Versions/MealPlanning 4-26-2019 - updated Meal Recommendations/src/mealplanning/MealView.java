...
public void updateMeal() {
    ...
    if(catalogView.getCurrentMeal().isPackable())
        packableButton.setText("Packable");
    else
        packableButton.setText("Dining");
    if(catalogView.getCurrentMeal().isCarbBase())
        carbBaseButton.setText("Base");
    else
        carbBaseButton.setText("-");
    if(catalogView.getCurrentMeal().isCookingIngredient())
...
//Meal Members:
  ...
  public Button meatButton = R.makeButton("-",370,true);
  public Button carbButton = R.makeButton("-",225,true); 
  public Button carbBaseButton = R.makeButton("Base",125,true);
  public Button vegButton = R.makeButton("-",370,true);
  public Button fruitButton = R.makeButton("-",370,true);
  public Button brandButton = R.makeButton("Generic",110,false);
  public Button cookingButton = R.makeButton("Cooking" + "\n" + "Ingredient",110,false);
  public Button packableButton = R.makeButton("Packable",110,false);
  

 public HBox idBox = new HBox(2);
 public HBox nameBox = new HBox(2);
 public HBox carbBox = new HBox(20);
 public HBox typeBox = new HBox(20);
...
public void setMeal()
{
    ...
    //Meal Members:
        ...
        carbBox.getChildren().addAll(carbButton,carbBaseButton);
        carbBox.setAlignment(Pos.CENTER);
        typeBox.getChildren().addAll(brandButton, cookingButton, packableButton);
        typeBox.setAlignment(Pos.CENTER);
        mealProperties.getChildren().addAll(idBox,nameBox,meatButton,carbBox,vegButton,fruitButton,typeBox);
...
//Custom Add Ingredients
    ingredientsAddCustom.setOnAction( e -> {  
            catalogView.getCurrentMeal().Ingredients.add(new Meal(00,ingredientsAddCustom.getText()));
...
//EditID:
    ...
    try{
      ...
      //Left Column Meal Properties Update Calls
        ...
        carbButton.setOnAction( e -> {     
            if(carbButton.getText()=="Carbohydrate")
             { carbButton.setText("-");
                ...
                carbBaseButton.setText("-");
            catalogView.getCurrentMeal().setCarbBase(false);
             } else{
            carbButton.setText("Carbohydrate");
            catalogView.getCurrentMeal().setCarb(true);
            carbBaseButton.setText("Base");
            catalogView.getCurrentMeal().setCarbBase(true);
            }catalogView.getCurrentMeal().print();});
       ...
       packableButton.setOnAction( e -> {     
            if(packableButton.getText().equals("Packable"))
             { packableButton.setText("Dining");
                catalogView.getCurrentMeal().setPackable(false);
             } else{
            packableButton.setText("Packable");
            catalogView.getCurrentMeal().setPackable(true);
            }catalogView.getCurrentMeal().print();});
       cookingButton.setOnAction( e -> {     
            if(cookingButton.getText()=="Cooking" + "\n" + "Ingredient")
             { cookingButton.setText("-");
                catalogView.getCurrentMeal().setCookingIngredient(false);
             } else{
            cookingButton.setText("Cooking" + "\n" + "Ingredient");
            catalogView.getCurrentMeal().setCookingIngredient(true);
            }catalogView.getCurrentMeal().print();});
       carbBaseButton.setOnAction( e -> {     
            if(carbBaseButton.getText().equals("Base"))
             { carbBaseButton.setText("-");
                catalogView.getCurrentMeal().setCarbBase(false);
             } else{
            carbBaseButton.setText("Base");
