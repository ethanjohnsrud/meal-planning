        ...
        menuAddCustom.setOnAction(e -> {
            try {
                if (breakfast.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-1) + 1, 0);
                }
                if (mondayLunch.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-2) + 1, 0);
                }
                if (mondayDinner.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-3) + 1, 0);
                }
                if (tuesdayLunch.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-4) + 1, 0);
                }
                if (tuesdayDinner.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-5) + 1, 0);
                }
                if (wednessdayLunch.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-6) + 1, 0);
                }
                if (wednessdayDinner.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-7) + 1, 0);
                }
                if (thursdayLunch.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-8) + 1, 0);
                }
                if (thursdayDinner.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-9) + 1, 0);
                }
                if (fridayLunch.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-10) + 1, 0);
                }
                if (fridayDinner.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-11) + 1, 0);
                }
                if (saturdayLunch.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-12) + 1, 0);
                }
                if (saturdayDinner.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-13) + 1, 0);
                }
                if (sundayLunch.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-14) + 1, 0);
                }
                if (sundayDinner.isSelected()) {
                    menuInsert(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false), getMenuIndex(-15) + 1, 0);
                }
                ...
                if (selectedItem.getID() != 0) {
                    for (int i = 0; i < Catalog.size(); i++) {
                        if (Catalog.get(i).getID() == selectedItem.getID()) {
                            Catalog.get(i).increasePopularity();
...
public void resetMakeMeal() {
    ...
    MakeMeal.add(new Meal(false, -1, "*****Make Meal*****", 0, false, false, false, false, false,false,false));
    MakeMeal.add(new Meal(false, -2, "*******************", 0, false, false, false, false, false,false,false));
    return;
}
...
public String makeMealIndicatorsUpdate(Meal status) {
    ...
    for(int i=1; i<MakeMeal.size()-1; i++) {
        ...
        if(MakeMeal.get(i).getName().charAt(0) != indent.charAt(0)){
            ...
            try {
                if (MakeMeal.get(i).getID() != 0 && !skip) {
                    for (int j = 0; j < Catalog.size(); j++) {
                        if (Catalog.get(j).getID() == MakeMeal.get(i).getID()) {
                            Catalog.get(i).increasePopularity();
...
private void makeMealSet() {
    ...
    makeMealCatalog.setOnAction(e -> {
        ...
        makeMealCatalog.setItems(Catalog); 
    });
    makeMealCustomAdd.setOnAction(e -> {
        makeMealAdd(new Meal(false, 00, menuAddCustom.getText(), 0, false, false, false, false, false,false,false));
...
//***********Menu Layout Operations****************************************    
    ...
    private void generateMealVariations(){
     ...
     public void resetMenu() {
        ...
        Menu.add(new Meal(false, -1, "*****Breakfast*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -2, "*****Monday Lunch*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -3, "*****Monday Dinner*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -4, "*****Tuesday Lunch*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -5, "*****Tuesday Dinner*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -6, "*****Wednesday Lunch*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -7, "*****Wednesday Dinner*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -8, "*****Thursday Lunch*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -9, "*****Thursday Dinner*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -10, "*****Friday Lunch*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -11, "*****Friday Dinner*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -12, "*****Saturday Lunch*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -13, "*****Saturday Dinner*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -14, "*****Sunday Lunch*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -15, "*****Sunday Dinner*****", 0, false, false, false, false, false,false,false));
        Menu.add(new Meal(false, -16, "***********************", 0, false, false, false, false, false,false,false));
...
//        makeMealscene.setFill(Color.GOLDENROD);
