...
{    
    if(sampleFill) {
        catalogView.Catalog.add(new Meal(true, 11,"mealOne",true,false,false,true,true,false,false));
        catalogView.Catalog.add(new Meal(true, 22,"mealTwo",true,true,false,false,false,true,false));
        catalogView.Catalog.add(new Meal(true, 33,"mealThree",true,true,false,false,false,false,true));
        catalogView.Catalog.add(new Meal(true, 44,"mealFour",false,true,true,false,true,true,true));
        catalogView.Catalog.add(new Meal(true, 55,"mealFive",true,false,false,false,false,false,false));      
