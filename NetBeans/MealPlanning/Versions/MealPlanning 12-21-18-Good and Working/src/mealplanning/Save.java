...
//            menuImport("Menu");
    ...
    public void exportData(String currentMenu) {
        catalogExport(false);
    ...
    public boolean catalogImport(boolean prompt) {
    try {
    ...
    public boolean catalogExport(boolean prompt) {
            try {
