...
//Meal Members:
  ...
  public Button packableButton = R.makeButton("Packable",150,true);
...
public void setMeal()
{
    ...
    //Meal Members:
        ...
        typeBox.getChildren().addAll(brandButton,packableButton);
...
//Custom Add Ingredients
    ingredientsAddCustom.setOnAction( e -> {  
            catalogView.getCurrentMeal().Ingredients.add(new Meal(false,00,ingredientsAddCustom.getText(),0,false,false,false,false,false,false,false));
