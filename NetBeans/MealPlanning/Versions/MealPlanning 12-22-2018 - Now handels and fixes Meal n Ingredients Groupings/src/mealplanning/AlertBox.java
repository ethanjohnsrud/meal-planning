...
public class AlertBox {
    ...
    public void editMenusList(ObservableList<String> MenusList) {
        ...
        saveButton5.setOnAction(e -> {window5.close(); new Save().menusListExport(true);});
        ...
        layout5.getChildren().addAll(title5,headerBox5,listView5,newButton5,saveButton5);
