...
import static mealplanning.MealPlanning.launching;
...
public class CatalogView {
    ...
    private boolean launching = MealPlanning.launching;
    ...
    public void updateCatalog() {
        ...
        catalogScene = new Scene(catalogControlBox);
        return;
    }
    ...
    //EditID:
        ...
        try{
            ...
            menuView.menuCatalogEditID.setText(Integer.toString(selectedItem.getID()));
    ...
    public Button goToMenuFromCatalog = R.makeButton("MENU", 100, false);
    public Button goToShoppingListFromCatalog = R.makeButton("SHOPPING LIST", 200, false);
    public Button catalogSaveAll = R.makeButton("SAVE ALL", 100, false);
    ...
    public Button testNotify = R.makeButton("Test Notify", 100, false);
    public Button testError = R.makeButton("Test Error", 100, false);
    ...
    public HBox catalogButtonsBox = new HBox(50);
    public VBox catalogControlBox = new VBox(30);
    
    public void setCatalog()
    {
        //Catalog
    goToMenuFromCatalog.setFont(R.DetailFont);
    goToMenuFromCatalog.setPrefWidth(100);
    goToShoppingListFromCatalog.setFont(R.DetailFont);
    goToShoppingListFromCatalog.setPrefWidth(150);
    catalogSaveAll.setFont(R.DetailFont);
