...
public HBox shoppingListButtonsBox = new HBox(50);
public VBox shoppingListControlBox = new VBox(30);
public Scene shoppingListScene = new Scene(shoppingListControlBox);
...
public void setShoppingList()
{
    ...
    //Shopping List
    goToCatalogFromShoppingList.setFont(R.DetailFont);
    goToCatalogFromShoppingList.setPrefWidth(100);
    goToMenuFromShoppingList.setFont(R.DetailFont);
    shoppingListSaveAll.setPrefWidth(100);
    shoppingListSaveAll.setFont(R.DetailFont);
