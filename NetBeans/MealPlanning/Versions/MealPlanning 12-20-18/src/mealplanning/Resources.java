...
public class Resources {
    ...
    public final Meal theOrigionalMeal = new Meal(true,0,"Origional",true,true,true,true,false); 
    public final Meal theBlankMeal = new Meal(false,0,"",false, false, false, false,false);  
    ...
    protected final int mealsFirst = 20;
    protected final int mealsLast = 29;
   
    
    public String catalogIDRequirements(List<Meal> Catalog) {
        try{
